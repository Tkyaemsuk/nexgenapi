...
[![PHP Version](https://img.shields.io/badge/PHP-%3E%3D%207.4-777BB4?style=for-the-badge&logo=php&logoColor=white)](https://www.php.net/)
[![API Version](https://img.shields.io/badge/API-v1.8.0-blue?style=for-the-badge&logo=fastapi&logoColor=white)](https://merchant.nexgenapi.xyz)
[![License](https://img.shields.io/badge/License-MIT-green?style=for-the-badge)](LICENSE)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-Yes-emerald?style=for-the-badge)](https://github.com/)
...
[เริ่มต้นใช้งาน](#-การเริ่มต้นใช้งาน) •
[การติดตั้ง](#-การติดตั้ง) •
[ตัวอย่างการใช้งาน](#-ตัวอย่างการใช้งาน-quick-examples) •
[API Reference](#-api-reference) •
[ระบบความปลอดภัย](#-ระบบความปลอดภัย-security--ip-access)
...
1. **IP Auto-Detection:** เมื่อยิงคำขอครั้งแรกจาก Server IP ระบบจะบันทึกสถานะเป็น `PENDING`
2. **IP Whitelisting:** ต้องได้รับการอนุมัติ (Approved) จากผู้ดูแลระบบ หรืออนุญาตผ่าน Dashboard ก่อน จึงจะเข้าถึง Endpoint การเงินได้
3. **Protected Header:** ทุกคำขอจะส่งผ่าน HTTPS พร้อม Header:
   ```http
...
- **Portal:** [https://merchant.nexgenapi.xyz](https://merchant.nexgenapi.xyz)
- **API Version:** `v1.8.0`
